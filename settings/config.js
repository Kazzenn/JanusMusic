module.exports = {
  TOKEN: process.env.TOKEN || "ODkyNjQ0MTUzMjk5NzA5OTcy.G9UeJ6.vjiCnlY8NwctCslM1tAW1-uCOBchdbCZdt3H0g",
  PREFIX: process.env.PREFIX || "--",
  embed: {
    color: process.env.color || "ff7d03",
  ...
  // others
  mongodb: process.env.MONGO_URL || "mongodb+srv://test1:kazzenn@cluster0.oxnmf.mongodb.net/?retryWrites=true&w=majority",
  filters: {
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://discord.gg/tVy4VP3FBP`,
    VoteURL: process.env.VoteURL || `https://discord.gg/tVy4VP3FBP`,
    Website: ``,
  },
  options: {
    embedFooter: true,
